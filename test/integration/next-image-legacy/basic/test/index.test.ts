...
function runTests(
  href: string,
  setupPage?: (browser: BrowserInterface) => Promise<void>
) {
...
async function hasImagePreloadBeforeCSSPreload(browser: BrowserInterface) {
  ...
  ;(process.env.TURBOPACK_DEV ? describe.skip : describe)(
    ...
    () => {
      ...
      describe('Client-side Image Component Tests', () => {
        const setupPage = (browser: BrowserInterface) =>
          browser.waitForElementByCss('#clientlink').click()
